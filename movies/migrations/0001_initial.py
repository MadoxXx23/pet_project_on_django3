# Generated by Django 3.1 on 2022-05-20 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(upload_to='images/movies/', verbose_name='Постер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='images/movie_shots/', verbose_name='Изображение')),
        ...
        migrations.AddField(
            model_name='movie',
            name='video',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='film_video', to='movies.video', verbose_name='Видео'),
        ),
    ]
